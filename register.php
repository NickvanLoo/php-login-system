...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $username_err = "Gebruikersnaam kan alleen letters, nummers en underscores bevatten.";
    } else{
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    $username_err = "Deze gebruikersnaam is niet beschikbaar of voldoet niet aan de eisen.";
                } else{
                    $username = trim($_POST["username"]);
                }
            } else{
                echo "Oeps er ging wat fout! Probeer het nog een keer";
            }
